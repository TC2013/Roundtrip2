 ...
 */
public class RetrieveHistoryPageTaskRunnable extends ServiceTaskRunnable {
    public RetrieveHistoryPageTaskRunnable() { }
    public RetrieveHistoryPageTaskRunnable(ServiceTransport transport) {
        super(transport);
    }
